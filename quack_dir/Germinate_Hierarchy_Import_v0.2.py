...
engine_str = "mysql://iwyp60:EnerrgyYo@localhost:3306/iwyp60_germinate_dev"
...
#NB: not a TRUE Foreign Key. More like a reference to another table index
	value = Column(String)
	created_on = Column(String)
	updated_on = Column(String)
      	def __repr__(self):
...
#NB: Country of Origin will need to go into notes... Unless there is another way of doing it?
...
#NB: All samples need to be added to the database BEFORE adding the parents.
